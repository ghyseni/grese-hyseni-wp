...
<html class="no-js" lang="en-US">
    ...
    <body>
        <header id="header">
            <h1><a title ="<?php bloginfo('title'); ?>" href="../../"><?php bloginfo('title'); ?></a></h1>
            <!-- .opened class will be added to #nav using a jquery funciton, to open the menu after clicking the menu button -->
            <nav id="nav">
                <?php wp_nav_menu(array('theme_location' => 'main-menu', 'container_class' => 'menu', 'menu_class' => 'menu')); ?>
                <?php wp_nav_menu(array('theme_location' => 'social-media', 'container_class' => 'network', 'menu_class' => '')); ?> 
            </nav>
